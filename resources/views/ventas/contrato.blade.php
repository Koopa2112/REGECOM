        ...
        <form action="{{ url('ventas/' . $venta->id .'/analisis') }}" method="post" id="analizarVenta">
            <div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control-plaintext" name="total_mensual" id="total_mensual" value="{{$total_mensual}}" readonly>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-5">
                        <textarea class="form-control" name="notas_MC" id="notas_MC">{{$venta->notas_MC}}</textarea>
                    </div>
                </div>
                ...
                <div class="col-sm-5">
                    <div class="col-sm">
                        <button type="button" style="flex-grow: 10" class="btn btn-danger btn-lg" id="btnRechazar" onclick="guardar(3)">Contrato no impreso</button>
                    </div>

                    <br>
                    <div class="col-sm">
                        <button type="button" style="flex-grow: 10" class="btn btn-success btn-lg" id="btnAceptar" onclick="guardar(7)">Contrato impreso</button>
                    </div>
                </div>
            </div>
